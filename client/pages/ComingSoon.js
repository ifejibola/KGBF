            ...
            <div className="offcanvas-wrap">
                <section className="cover overflow-hidden bg-black inverted">
                    ...
                    <div class="browser shadow">
                        <img src="/images/IMG_6122.JPG" class="img-fluid" alt="Image" />
                        <span></span>
                    </div>
                    <div className="background background-overlay text-black" >
                        ...
                        {/* <video playsinline controls data-video>
                            <source src="videos/flash.mp4" type="video/mp4" />
                            <source src="videos/video.webm" type="video/webm" />
                        </video>
                        <video playsInline autoPlay loop muted data-video>
                        <source src="videos/flash.mp4" type="video/mp4" />
                        <source src="https://vimeo.com/637288061" type="video/mp4" class="plyr__video-embed" />
